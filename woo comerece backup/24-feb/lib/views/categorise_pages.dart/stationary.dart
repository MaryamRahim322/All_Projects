...
import 'package:woo_commerce_app/data/controllers/category_pages_controllers/stationary_controller.dart';
...
class StationaryScreen extends StatelessWidget {
  var controller = Get.put(StationaryScreenController());
  StationaryScreen({super.key});
