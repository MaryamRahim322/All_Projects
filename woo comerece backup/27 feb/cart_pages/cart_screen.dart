              ...
              InkWell(
                onTap: () {
                  Get.defaultDialog(
                      ...
                      titlePadding: EdgeInsets.only(top: 1.6.h),
                      content: Column(
                        children: [
                          Padding(
                            padding: EdgeInsets.only(top: 1.6.h, bottom: 1.4.h),
                            child: Text(
                              "Items you choose will be deleted from the cart.",
                      ...
                      titleStyle: AppTextStyles.hBold
                          .copyWith(color: AppColors.colorBlack),
                      middleTextStyle: AppTextStyles.hBold
                          .copyWith(color: AppColors.colorBlack),
                      radius: 14);
                },
                child: Text(
